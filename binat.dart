...
void main() {
  ...
  print('The value of variable a is ' +
      a.toString()); // You must change to String to get display output
  print('The value of variable b is ' + b.toString()); // Same case variable a
  print('The value of variable c is ' +
      c); // Because 'c' in String, so that's can display without use convert
  ...
  /*
    You cannot re define data with difference type data. For example like this :
    a = 373.33; -> get error
  ...
  dynamic h = a;
  print('The value of variable h is ' +
      h.toString() +
      ' -> Type : ' +
      h.runtimeType.toString());
  h = b;
  print('The value of variable h is ' +
      h.toString() +
      ' -> Type : ' +
